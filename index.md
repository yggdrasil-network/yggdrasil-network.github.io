...
- Alternatively, come and chat to us on the [Freenode IRC network](irc://chat.freenode.net/yggdrasil) in `#yggdrasil` (the room password is `SpanningTrees` - sadly this is necessary to avoid the current spam problem on Freenode).
